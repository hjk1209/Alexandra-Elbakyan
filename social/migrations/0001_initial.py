    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.FileField(blank=True, upload_to='posts/%Y/%m/', validators=[django.core.validators.FileExtensionValidator(['jpg', 'jpeg', 'png', 'webp'])])),
                ('visibility', models.CharField(choices=[('public', 'Publico'), ('community', 'Comunidade'), ('followers', 'Seguidores')], default='community', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('follower', 'following'), name='unique_follow_relationship'), models.CheckConstraint(condition=models.Q(('follower', models.F('following')), _negated=True), name='follow_cannot_target_self')],
            },
        ),
        migrations.CreateModel(
            name='PostLike',
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('post', 'user'), name='unique_like_per_post')],
            },
        ),
    ]
